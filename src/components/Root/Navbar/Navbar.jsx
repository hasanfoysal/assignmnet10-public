...
const Navbar = () => {
  ...
  const handleSignOut = () =>{
    ...
    <li className="text-xl"><NavLink to='/'>Home</NavLink></li>
      ...
      <li className="text-xl"><NavLink to="/list">My List</NavLink></li>
  ...
  <div className="navbar-start">
    ...
    <a className=" lg:text-3xl font-bold ml-4">Destination<h1 className="text-teal-500 font-bold">Dares</h1> </a>
  </div>
...
</label>
{
        ...
        :
        <Link to='/login'>
        <button className="btn btn-outline btn-accent mr-4">Login</button>
        </Link>
      }
  </div>
</div>
