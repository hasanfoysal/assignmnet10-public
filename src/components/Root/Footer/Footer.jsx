...
const Footer = () => {
  ...
  <nav className="lg:ml-16">
    ...
    <a className="link link-hover">All Hotels</a>
    <a className="link link-hover">Become a Supplier</a>
...
<footer className="footer px-10 py-4 border-t bg-black text-white border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Destination dares Ltd. <br/>Providing reliable tech since 2000</p>
  </aside> 
